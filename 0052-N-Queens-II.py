...
def nQueensSolutionV2(n, returnType):
    # *** This function is not working, but I haven't debugged it ***

    # Note: returnType is 1 if only number of positions are needed, and
    #       2 if all boards are required.
